const navbar = {
    ...
    template: `
        <div class="col-2 vh-100 sticky-top p-2">
            <nav class="h-100 p-0 d-flex justify-content-between flex-column overflow-scroll rounded background">
                <div class="container p-2">
                    <a href="/" class="navbar-brand d-block my-3 mx-auto text-center link-light text-decoration-none">
                        <i class="bi bi-egg me-1 fs-4"></i>
                        <span class="fs-4 bold align-middle">LiftingSpirits</span>
                    </a>
